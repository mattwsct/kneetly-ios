...
//FIXME: use from KneetlyCommon
class FormTextField: UITextField, ValidatableControl {
    ...
    func validatableValueDidChanged(value: String) {
        displayNormalState()
    }
    ...
    private func displayInvalidState() {
        self.textColor = R.color.kneetly.cancelOrange()
        self.placeholderColor = R.color.kneetly.cancelOrange()
        self.shake()
    }
}
