//
//  ApiEndpoints+BookingsList.swift
//  KneetlyWashersApp
//
...
extension ApiEndpoints {
    ...
    public struct BookingsListRequest {
        public static func getBookingsList() -> ApiRequest<[BookingWash], ApiErrorCategory<ApiDefaultError>> {
            return ApiRequest(
                httpMethod: .get,
                apiMethodName: "washer/wash/request/list",
                params: nil,
